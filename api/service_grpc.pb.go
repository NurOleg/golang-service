...
const (
	...
	UserService_GetJwtToken_FullMethodName = "/UserService/GetJwtToken"
)
...
func (c *userServiceClient) GetJwtToken(ctx context.Context, in *GetJwtTokenRequest, opts ...grpc.CallOption) (*GetJwtTokenResponse, error) {
	out := new(GetJwtTokenResponse)
	err := c.cc.Invoke(ctx, UserService_GetJwtToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) GetJwtToken(context.Context, *GetJwtTokenRequest) (*GetJwtTokenResponse, error) {
...
func _UserService_GetJwtToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetJwtToken(ctx, req.(*GetJwtTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
